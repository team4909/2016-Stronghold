...
public class OI {
    ...
    public OI() {
        ...
        //Pivot
        pivotUpButton = new JoystickButton(operatorControl, 3); //Y Button
        pivotUpButton.whileHeld(new PivotUp());

        pivotDownButton = new JoystickButton(operatorControl, 0); //X Button
        pivotDownButton.whileHeld(new PivotDown());
        
        //Shooter/Feeder
        shootButton = new JoystickButton(operatorControl, 7); //Right Back Trigger
        shootButton.whenPressed(new Shoot());
        
        readyShotButton = new JoystickButton(operatorControl, 6); //Left Back Trigger
        readyShotButton.whenPressed(new StartShooter());
        
        intakeButton = new JoystickButton(operatorControl, 1); //A Button        
